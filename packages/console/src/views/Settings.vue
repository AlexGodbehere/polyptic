    ...
    <div class="inner">
      ...
      <section id="sec-netboot" class="card pad-lg">
        ...
        <p class="card-sub wrap gap">
          ...
          USB stick and it streams the current image into RAM — so the box needs <b>~2&nbsp;GB of RAM</b>. For less,
          download a build's live ISO below: it runs off the stick and needs <b>~1&nbsp;GB</b>. The control-plane URL
