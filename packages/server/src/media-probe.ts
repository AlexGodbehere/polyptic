 ...
 *
 * DEGRADE, NEVER REFUSE (D123). A dev laptop or a minimal container may have no toolchain at all. In
 ...
 * missing the prober simply reports itself unavailable and the server degrades (D123).
 */
