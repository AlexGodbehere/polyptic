...
| **Netboot** (diskless box, *no OS install*) | a **live image** + a tiny **iPXE boot medium**, served by the depot (D45) | HTTP-boot / a USB dongle → the box streams into RAM | nothing persists on the box — see [NETBOOT.md](NETBOOT.md) |
